...
# Lista vazia que vai armazenar os produtos adicionados pelo usuário
carrinho = []
...
# Laço while para adicionar produtos ao carrinho até o usuário digitar "sair"
while True:
...
# Calcula o valor total percorrendo o carrinho e consultando o dicionário de preços
total = 0.0
...
# Aplica 10% de desconto se o total for maior que R$ 100,00
if total > 100:
    desconto = total * 0.10
